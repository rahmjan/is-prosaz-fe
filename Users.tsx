                ...
                <TableRow key={index}>
                  ...
                  <TableCell width={200} align="right">
                    <ButtonGroup variant="text" aria-label="outlined primary button group">
                      ...
                      >
                        <DialogTitle>Opravdu chcete vymazat uzivatele?</DialogTitle>
                        <DialogContentText variant="h6" align="center">{c.name} {c.surname}</DialogContentText>
                        <DialogActions>
                          <Button variant="outlined" color="primary" onClick={handleDeleteClose} endIcon={<CloseIcon/>}>Zrusit</Button>
